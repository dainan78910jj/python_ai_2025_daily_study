...
# Fill in the missing prompts to make 12 prompts total
# Creating additional prompts to make up the 12 prompts
additional_prompts = [
    ...
    'Summarize in one sentence: Batching several prompts can improve throughput. Padding and masks keep shapes compatible.',
    'Summarize in one sentence: Beam search is deterministic and often fluent. Sampling adds creativity but may drift.',
    'Summarize in one sentence: SentencePiece and WordPiece split text into subwords. This keeps vocabulary small and improves coverage.'
]
